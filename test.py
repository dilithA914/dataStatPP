...
if(category=="4"):
    ...
    print("\t1.Basic Sanitation Overall Access")
    print("\t2.Basic Water Sources , Overall Access")
    print("\t3.Mobile Phones , Overall Access")
    print("\t4.Internet , Overall Access")

    chart_num=input("Enter Category(Number) :")
    if(chart_num=="1"):
        ylbl="Percentage"
        title="Basic Sanitation Overall Access"
        chart=(folder+"sanitation.csv")

    elif(chart_num=="2"):
        ylbl="Percentage"
        title="Basic Water Sources, Overall Access"
        chart=(folder+"water.csv")

    elif(chart_num=="3"):
        ylbl="Moibile phones per 100 persons"
        title="Mobile Phones, Overall Access"
        chart=(folder+"cellphone.csv")
...
if(category=="6"):
    folder=("society/")
    print("\t1.Corruption ; based on CPI index")
    print("\t2.Human Development Index- (Health/Education/Living)")
    print("\t3.Democracy Score,  Based on Polity score / polity iv dataset")

    chart_num=input("Enter Category(Number) :")
    if(chart_num=="1"):
        ylbl="CPI index value"
        title="Corruption based on CPI index"
        chart=(folder+"corruption.csv")

    elif(chart_num=="2"):
        ylbl="HDI value"
        title="Human Development Index- (Health/Education/Living)"
        chart=(folder+"hdi.csv")

    elif(chart_num=="3"):
        ylbl="polity score"
        title="Democracy Score ( -10 to +10)"
        chart=(folder+"democ.csv")
